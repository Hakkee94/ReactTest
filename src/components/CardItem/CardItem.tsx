...
function CardItem(item) {
    ...
    return (
        <div className='card-item'>
            <div className='card-item-img'><img src={baseUrl + item.src} alt={item.name} /></div>
            <div className='card-item-name'>{item.name}</div>
            <div className='card-item-info'>
                <div className='card-item-price'>$ {item.price}</div>
                <svg className='svg-heart' xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
